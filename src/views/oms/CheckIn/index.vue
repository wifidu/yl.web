...
<!--        </el-table-column>-->
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              size="mini"
              @click="handleViewOrder(scope.$index, scope.row)">详情</el-button>
            <el-button
              size="mini"
              type="danger"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleAdd(){
        this.$router.push({path:'/oms/checkin_newDetail',query:{id:0,edit:false}})
      },
      handleChangeOrder(index, row){
        this.$router.push({path:'/oms/checkin_editDetail',query:{id:row.id,edit:false}})
      },
      handleViewOrder(index, row){
        this.$router.push({path:'/oms/checkin_viewDetail',query:{id:row.id,edit:true}})
      },
