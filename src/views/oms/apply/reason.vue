...
<!--        </el-button>-->
        <el-form :inline="true" :model="add_list" size="small" label-width="180px" style="margin-top: 25px">
          <el-form-item label="会员姓名：">
            <el-input v-model="add_list.member_name" class="input-width" placeholder="" style="width:300px"></el-input>
          </el-form-item>
          <el-form-item label="床位号：">
            <el-input v-model="add_list.bed_number" class="input-width" placeholder="" style="width:300px"></el-input>
          </el-form-item>
          <el-form-item label="外出时间：">
            <el-input v-model="add_list.out_time" class="input-width" placeholder="" style="width:300px"></el-input>
          </el-form-item>
          <el-form-item label="计划返回时间：">
            <el-input v-model="add_list.plan_to_return" class="input-width" placeholder="" style="width:300px"></el-input>
          </el-form-item>
          <el-form-item label="请假天数：">
            <el-input v-model="add_list.leave_days" class="input-width" placeholder="" style="width:300px"></el-input>
          </el-form-item>
          <el-form-item label="陪同人姓名：">
            <el-input v-model="add_list.accompany_name" class="input-width" placeholder="" style="width:300px"></el-input>
          </el-form-item>
          <el-form-item label="陪同人电话：">
            <el-input v-model="add_list.accompany_number" class="input-width" placeholder="" style="width:300px"></el-input>
          </el-form-item>
          <el-form-item label="外出原因：">
            <el-input v-model="add_list.out_reason" class="input-width" placeholder="" style="width:794px"></el-input>
          </el-form-item>
          <el-form-item label="登记人：">
            <el-input v-model="add_list.register_person" class="input-width" placeholder="" style="width:300px"></el-input>
          </el-form-item>
          <el-form-item label="登记时间：">
            <el-input v-model="add_list['check-in_time']" class="input-width" placeholder="" style="width:300px"></el-input>
          </el-form-item>
          <el-form-item label="返回时间：">
            <el-input v-model="add_list.return_time" class="input-width" placeholder="" style="width:300px"></el-input>
          </el-form-item>
          <el-form-item label="实际请假天数：">
            <el-input v-model="add_list.actual_leave_days" class="input-width" placeholder="" style="width:300px"></el-input>
          </el-form-item>
          <el-form-item label="总计：">
            <el-input v-model="add_list.total" class="input-width" placeholder="" style="width:300px"></el-input>
          </el-form-item>
        </el-form>
      </el-card>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleViewOrder(data,row){
        this.$router.push({path:'/oms/listLogin',query:{id:row.id}})
      },
      getList(){
        this.listLoading = true;
