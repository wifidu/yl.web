    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="4" class="table-cell" >{{order.bed}}</el-col>
...
<script>
  import {getChangeDetail,updateReceiverInfo,updateMoneyInfo,closeOrder,updateOrderNote,deleteOrder} from '@/api/order';
  ...
  export default {
    ...
    created() {
      ...
      getChangeDetail(this.id).then(response => {
