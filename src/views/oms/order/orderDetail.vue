    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        <el-row>
          ...
          <el-col :span="4" class="table-cell-title">签约医生</el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="4" class="table-cell" >{{order.sign_doctor}}</el-col>
        </el-row>
        <el-row>
          <el-col :span="4" class="table-cell-title">身高</el-col>
          <el-col :span="4" class="table-cell-title">体重</el-col>
          <el-col :span="4" class="table-cell-title">出生日期</el-col>
          <el-col :span="4" class="table-cell-title">电子邮箱</el-col>
          <el-col :span="4" class="table-cell-title">地址</el-col>
          <el-col :span="4" class="table-cell-title">电话号码</el-col>

        </el-row>
        <el-row>
          <el-col :span="4" class="table-cell">{{order.height}}</el-col>
          <el-col :span="4" class="table-cell">{{order.weight}}</el-col>
          <el-col :span="4" class="table-cell">{{order.birth_data}}</el-col>
          <el-col :span="4" class="table-cell">{{order.email}}</el-col>
          <el-col :span="4" class="table-cell">{{order.adress}}</el-col>
...
<!--          </el-col>-->
      ...
      <div style="margin-top: 20px">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
        <span class="font-small">健康信息</span>
      </div>
      <div class="table-layout">
        <el-row>
          <el-col :span="6" class="table-cell-title">会员名称</el-col>
          <el-col :span="6" class="table-cell-title">手机号码</el-col>
          <el-col :span="6" class="table-cell-title">健康状态</el-col>
          <el-col :span="6" class="table-cell-title">地址</el-col>
        </el-row>
        <el-row>
          <el-col :span="6" class="table-cell">{{order.member_name}}</el-col>
          <el-col :span="6" class="table-cell">{{order.phone_number}}</el-col>
          <el-col :span="6" class="table-cell">{{order.own_system}}</el-col>
          <el-col :span="6" class="table-cell">{{order.adress}}</el-col>
        </el-row>
      </div>
      <div style="margin-top: 20px">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
        <span class="font-small">评估信息</span>
      </div>
      <el-table
        ref="orderItemTable"
        :data="order.orderItemList"
        style="width: 100%;margin-top: 20px" border>
        <el-table-column label="会员照片" width="120" align="center">
        ...
        <el-table-column label="健康评估" align="center">
          <template slot-scope="scope">
            ...
            <p>待定：{{scope.row.productBrand}}</p>
          </template>
        </el-table-column>
        <el-table-column label="待定" width="120" align="center">
          <template slot-scope="scope">
            <p>待定：￥{{scope.row.productPrice}}</p>
            <p>待定：{{scope.row.productSn}}</p>
          </template>
        </el-table-column>
        <el-table-column label="待定" width="120" align="center">
          <template slot-scope="scope">
      ...
      <div style="float: right;margin: 20px">
        总评：<span class="color-danger">￥{{order.totalAmount}}</span>
      </div>
      ...
      <div class="table-layout">
        <el-row>
          <el-col :span="6" class="table-cell-title">待定</el-col>
          <el-col :span="6" class="table-cell-title">待定</el-col>
          <el-col :span="6" class="table-cell-title">待定</el-col>
          <el-col :span="6" class="table-cell-title">待定</el-col>
        </el-row>
