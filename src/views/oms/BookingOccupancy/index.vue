...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      handleAdd(){
        this.$router.push({path:'/oms/book_newDetail',query:{id:0,edit:false}})
      },
      handleChangeOrder(index, row){
        this.$router.push({path:'/oms/book_editDetail',query:{id:row.id,edit:false}})
      },
      handleViewOrder(index, row){
        this.$router.push({path:'/oms/book_viewDetail',query:{id:row.id,edit:true}})
      },
