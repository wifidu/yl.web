  ...
  <div style="margin-top: 50px">
    <el-form :model="value" ref="productAttrForm" label-width="120px" style="width: 720px" size="small">
      ...
      <el-form-item style="text-align: center">
        <el-button size="medium" @click="handlePrev">上一步，报告上传</el-button>
        <el-button type="primary" size="medium" @click="handleNext">下一步，费用计算</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
