<template>
<!--  <div style="background: #9E9E9E; width: 100%">基础信息</div>-->
  <div style="margin-top: 50px">
    <el-form :model="value" :rules="rules" ref="productInfoForm" label-width="120px" style="width: 600px" size="small">
<!--      <el-form-item label="会员姓名：" prop="productCategoryId">-->
<!--        <el-cascader-->
...
<!--      </el-form-item>-->
<!--      <el-form-item label="相关图片：" v-if="hasAttrPic">-->
...
<script>
  ...
  //   },
    ...
    methods: {
      ...
      getBrandList() {
        fetchBrandList({pageNum: 1, pageSize: 1}).then(response => {
          this.brandOptions = [];
