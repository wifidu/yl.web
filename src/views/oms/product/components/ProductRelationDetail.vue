    ...
    <el-form :model="value"
      ...
      <div style="margin-top: 50px">
        <el-form :model="value" :rules="rules" ref="productInfoForm" label-width="120px" style="width: 600px" size="small">
          <el-form-item label="费用结算：" prop="subTitle" style="width: 40%">
            0
          </el-form-item>
        </el-form>
      </div>
      <el-form-item style="text-align: center">
        <el-button size="medium" @click="handlePrev">上一步，能力评估</el-button>
        <el-button type="primary" size="medium" @click="handleViewOrder">入住完成</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
