    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        <el-row>
          ...
          <el-col :span="4" class="table-cell-title">工位名称</el-col>
          <el-col :span="4" class="table-cell-title">工作描述</el-col>
        </el-row>
        <el-row>
          <el-col :span="4" class="table-cell">{{order.id}}</el-col>
          <el-col :span="4" class="table-cell">{{order.created_at}}</el-col>
          <el-col :span="4" class="table-cell">{{order.department_name}}</el-col>
          <el-col :span="4" class="table-cell" >{{order.department_description}}</el-col>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      Detail(this.id,'/personnel-management/department-manage/').then(response => {
