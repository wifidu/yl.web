  ...
  <div class="detail-container">
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        <el-row>
          <el-col :span="4" class="table-cell-title">团队名称</el-col>
          <el-col :span="4" class="table-cell-title">服务类型</el-col>
          <el-col :span="4" class="table-cell-title">团队描述</el-col>
          <el-col :span="4" class="table-cell-title">团队成员</el-col>
          <el-col :span="4" class="table-cell-title">负责人</el-col>
        </el-row>
        <el-row>
          <el-col :span="4" class="table-cell">{{order.team_name}}</el-col>
          <el-col :span="4" class="table-cell">{{order.service_type}}</el-col>
          <el-col :span="4" class="table-cell">{{order.team_description}}</el-col>
          <el-col :span="4" class="table-cell" >{{order.team_members}}</el-col>
          <el-col :span="4" class="table-cell" >{{order.header}}</el-col>
        </el-row>
<!--        <el-row>-->
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      Detail(this.id,'/personnel-management/team-manage/').then(response => {
