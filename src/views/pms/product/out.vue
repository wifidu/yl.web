<template> 
  <div style="margin-top: 30px;">
    ...
    <el-form :model="value" :rules="rules" size="small" :inline="true" label-width="140px" style="text-align: center">
      <el-form-item label="去向：" prop="name">
        <el-select
          @change="handleBrandChange"
          v-model="rules.brandId"
          placeholder="领用">
      ...
      <el-form-item  label="领用人：" prop="name">
        <el-input style="width: 203px" v-model="listQuery.keyword" placeholder="领用人"></el-input>
      </el-form-item>
    </el-form>
    ...
    <el-card shadow="never" style="margin-top: 30px">
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="6" class="table-cell">原仓库</el-col>
        </el-row>
        <el-row>
