...
<!--            <el-input v-model="searchList.member_name" class="input-width" placeholder="单品名称"></el-input>-->
<!--          </el-form-item>-->
<!--        </el-form>-->
<!--      </div>-->
<!--    </el-card>-->
    ...
    <div class="table-container" style="width: 100%">
      <el-table ref="orderTable"
        ...
        <el-table-column label="单品状态" width="" align="center">
          <template slot-scope="scope" >{{scope.row.food_type===0?'新鲜': '售空'}}</template>
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //     getList(this.search_name,"/diet-manage/food-manage/search/").then(response => {
      ...
      //     getList(this.search_phone,"/diet-manage/food-manage/search").then(response => {
      //       this.listLoading = false;
      //       this.list = response.data;
      //       console.log(response)
      //     });
      ...
      handleAdd(){
        this.$router.push({path:'/food/food_new',query:{id:0,edit:false}})
      },
      handleChangeOrder(index, row){
        this.$router.push({path:'/food/food_edit',query:{id:row.id,edit:false}})
      },
      handleViewOrder(index, row){
        this.$router.push({path:'/food/food_view',query:{id:row.id,edit:true}})
      },
      ...
      getList() {
        this.listLoading = true;
        getList(this.dataList,"/diet-manage/food-manage/list/").then(response => {
          this.listLoading = false;
          this.list = response.data.data;
          this.list.food_type = parseInt(this.list.food_type)
      ...
      deleteOrder(ids){
        this.$confirm('是否要进行该删除操作?', '提示', {
          ...
          deleteOrder('/diet-manage/food-manage/',ids).then(response=>{
            this.$message({
              message: '删除成功！',
              type: 'success',
              duration: 1000
